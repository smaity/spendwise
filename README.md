...
SpendWise keeps your financial data on your own devices — there's no SpendWise server or account.
See the full [Privacy Policy](PRIVACY.md) (including the Google API Limited Use disclosure) and
